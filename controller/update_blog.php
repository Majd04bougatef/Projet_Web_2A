...
if (
    ...
    if (
        ...
        $blogC->updateblog($blog, $_POST["id_b"]);
        $firstLetter = substr($_SESSION['user_id'], 0, 1);
        if ($firstLetter=='M')
            header('Location:listeblog_med.php');
        else
    ...
    <div class="container">
        <div class="modal">
            <div class="modal__header">
                <span class="modal__title">Modifier Article</span>
            ...
            <div class="input">
                    <label class="input__label" for="id_b">ID : </label>
                    <input class="input__field" type="text" name="id_b" id="id_b" autocomplete="off" value="<?php echo $blog['id_b']; ?>">
                </div>
                <div class="input">
                    <label class="input__label" for="titre_blog">Titre</label>
                    <input class="input__field" name="titre_blog" type="text" id="titre_blog" autocomplete="off" value="<?php echo $blog['titre_blog']; ?>">
                ...
                <div class="input">
                    ...
                    <input class="input__field" type="text" name="sujet_blog" id="sujet_blog" autocomplete="off" value="<?php echo $blog['sujet_blog']; ?>">
                </div>
                <div class="input">
                    <label class="input__label" for="desc_blog">Description</label>
                    <input class="input__field input__field--textarea" name="desc_blog" id="desc_blog" autocomplete="off" value="<?php echo $blog['desc_blog']; ?>"></textarea>
                    ...
                    <input class="input__field" name="date_blog" type="date" id="date_blog" autocomplete="off" value="<?php echo $blog['date_blog']; ?>">-->
