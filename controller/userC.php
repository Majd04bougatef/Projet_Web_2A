...
public function adduser($user)
{
    try {
        $db = config::getConnexion();
        $query = $db->prepare('INSERT INTO user (cin, nom, prenom, age, sexe, telephone, nationalite, email, password, role, diplome, specialite, pays, ville, lieu_cabinet, image) VALUES (:cin, :nom, :prenom, :age, :sexe, :telephone, :nationalite, :email, :password, :role, :diplome, :specialite, :pays, :ville, :lieu_cabinet, :image)');
        $query->execute([
            'cin' => $user->getcin(),
            'nom' => $user->getnom(),
            ...
            'image' => $user->getimage() // Add this line to include the image path
        ]);
