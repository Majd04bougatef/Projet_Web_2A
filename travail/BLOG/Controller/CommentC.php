...
class commentC
{
    ...
    {
        $sql = "SELECT * FROM commentaire where isdelete=0";
    ...
    {
        $sql = "UPDATE commentaire SET isdelete = 1 WHERE id_com = :id";
        $db = config::getConnexion();
    ...
    {
        $sql = "INSERT INTO `commentaire` (`id_com`, `id_b`, `date_commentaire`, `desc_commentaire`) VALUES (NULL, :id_b, :date_commentaire, :desc_commentaire);";
    ...
    {
        $sql = "SELECT * FROM commentaire WHERE id_com = $id AND isdelete = 0";
        $db = config::getConnexion();
        try {
            $query = $db->prepare($sql);
            $query->execute();
    ...
    {
        $sql = "SELECT * FROM commentaire WHERE id_b = :blogId AND isdelete = 0";
        $db = config::getConnexion();
