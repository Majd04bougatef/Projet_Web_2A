...
.add-button {
    ...
    transition: background-color 0.3s ease-in-out; /* Transition de couleur au survol */
}
    ...
    <button type="submit" class="search-button">Rechercher</button>
        ...
        <div class="event-container">
            ...
            ?>
                ...
                <img class="event-image" src="image/<?php echo isset($event['image']) ? $event['image'] : 'placeholder.gif'; ?>" alt="<?php echo isset($event['image']) ? htmlspecialchars($event['image']) : 'eventImage'; ?>">
