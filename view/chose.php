...
<body>
    <table>
        <th><a href="../view/listerdv.php"><button>tous les patients</button></a></th>
        <th><a href="../view/rdvP.php"><button>patient spécifique</button></a></th>
        <th><a href="../view/rdvM.php"><button>doctor spécifique</button></a></th>
    </table>  
</body>
</html>
