...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo me-auto"><img src="front/assets/img/logo.png" alt="" class="img-fluid"></a>-->
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="section-title">
         <h2>Votre Réclamation Nous aide à améliorer nos services.</h2>
      </div>
      <div align="center">
          <a href="ajouterReclamationFrontMedecin.php">
            <button class="appointment-btn scrollto">
                Réclamer en tant que médecin
            </button>
          </a>
          <a href="ajouterReclamationFrontPatient.php">
            <button class="appointment-btn scrollto">
                Réclamer en tant que patient
            </button>
          </a>
      </div>
